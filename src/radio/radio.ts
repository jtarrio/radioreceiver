...
export class Radio extends EventTarget {
    ...
    private static SAMPLES_PER_BUF = Math.floor(Radio.SAMPLE_RATE / Radio.BUFS_PER_SEC);
            ...
            try {
                switch (this.state) {
                    case State.OFF: {
                        ...
                        transfers = new Transfers(rtl, this.sampleReceiver, this, Radio.SAMPLES_PER_BUF);
 ...
 */
class Transfers {
    constructor(private rtl: RTL2832U, private sampleReceiver: SampleReceiver, private radio: Radio, private samplesPerBuf: number) {
    ...
    private readStream() {
        this.rtl.readSamples(this.samplesPerBuf).then(b => {
