...
export class Demodulator extends EventTarget implements SampleReceiver {
    ...
    addEventListener(type: 'demodulator', callback: (e: DemodulatorEvent) => void | null, options?: boolean | AddEventListenerOptions | undefined): void;
    addEventListener(type: 'signalLevel', callback: (e: SignalLevelEvent) => void | null, options?: boolean | AddEventListenerOptions | undefined): void;
...
class SignalLevelDispatcher {
    ...
    dispatch(level: number, samples: number) {
        ...
        this.demodulator.dispatchEvent(new SignalLevelEvent(this.sum / this.samples));
