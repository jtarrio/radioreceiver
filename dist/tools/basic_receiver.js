(function () {
        ...
        async runLoop() {
            ...
            while (true) {
                if (msgPromise === undefined)
                    msgPromise = this.channel.receive();
                switch (this.state) {
                    case State.OFF: {
    ...
    function getControls() {
        return {
            start: document.getElementById('elStart'),
            ...
            scanMin: document.getElementById('elScanMin'),
            scanMax: document.getElementById('elScanMax'),
            scanStep: document.getElementById('elScanStep'),
            scanUp: document.getElementById('elScanUp'),
            scanDown: document.getElementById('elScanDown'),
        };
    }
